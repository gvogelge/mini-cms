    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('home') }}" class="text-gray-700 hover:text-lime-500 font-medium transition">Home</a>
                <a href="{{ route('posts.create') }}" class="text-gray-700 hover:text-lime-500 font-medium transition">Post</a>
            </div>
